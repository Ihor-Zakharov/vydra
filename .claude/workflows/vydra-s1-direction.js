...
Решение пользователя: стеклянный стиль интерфейса (glass UI) больше НЕ требование — правило «стекло на кнопках и
органах управления» в core.css не обязательно: оставь, замени или убери. Главное — классная анимация сцены, а всё
остальное должно гармонировать с чёрной дырой.
...
2. Напиши docs/design/DIRECTION.md. Обязательно:
   ...
   - токены тёмной темы с точными значениями: цвет (фон, поверхности, текст 3 уровней, линии, излучение, статусы,
     цвета платформ только «в излучении»), радиусы, тени/свечение, зерно; сетка и шкала отступов; типографика
