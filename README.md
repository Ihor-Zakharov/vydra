...
Повторный запуск установщика — тоже обновление: работающий веб-интерфейс он перезапустит новой версией сам
(в том же окне терминала; то же делает `vydra restart`).
